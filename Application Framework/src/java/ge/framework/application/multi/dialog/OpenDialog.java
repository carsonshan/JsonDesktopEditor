...
public class OpenDialog extends ApplicationStandardDialog implements ActionListener
{
    ...
    public OpenDialog( InitialDialog owner, MultiFrameApplication application )
    {
    ...
    {
        MultiFrameApplication application = getApplication();

        frameDefinitions = application.getFrameDefinitions();
    ...
    public void actionPerformed( ActionEvent event )
    {
        ...
        else if ( source == browseButton )
        {
            TypeFolderChooser folderChooser =
                    new TypeFolderChooser( ( MultiFrameDefinition ) frameDefinitionField.getSelectedItem() );
            ...
            if ( result == TypeFolderChooser.APPROVE_OPTION )
            {
                ...
                MultiFrameDefinition type = ( MultiFrameDefinition ) frameDefinitionField.getSelectedItem();
                ...
                if ( type.isConfigurationFileLocked( pathFile ) == true )
                {
                    ...
                    problem.putArgument( "typeName", type.getName() );
