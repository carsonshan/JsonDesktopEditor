                                                                    ...
                                                                    CaretListener
{
    ...
    public NewDialog( InitialDialog owner, MultiFrameApplication application )
    {
    ...
    public NewDialog( FrameDefinition frameDefinition, MultiFrameApplication application )
    {
        super( application );
    ...
    public void actionPerformed( ActionEvent event )
    {
        ...
        if ( source == okButton )
        {
            ...
            if ( okButton.isEnabled() == true )
            {
                ...
                MultiFrameDefinition frameDefinition = ( MultiFrameDefinition ) frameDefinitionsField.getSelectedItem();
