...
import ge.framework.application.multi.dialog.panel.MultiFrameApplicationBannerPanel;
...
public class InitialDialog extends StandardDialog implements ListSelectionListener
{
    ...
    private MultiFrameApplicationBannerPanel bannerPanel = null;
    ...
    public void valueChanged( ListSelectionEvent e )
    {
        ...
        if ( source == recentListPanel.getList() )
        {
            ...
            {
                if ( application.openFrame( frameInstanceDetailsObject, true ) == true )
                {
                    dispose();
                }
            }
