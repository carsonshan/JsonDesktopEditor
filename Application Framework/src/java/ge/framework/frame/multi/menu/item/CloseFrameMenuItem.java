 ...
 * Time: 11:23
 */
public class CloseFrameMenuItem extends StatusBarEnabledSpacerMenuItem implements ActionListener
{
    ...
    public CloseFrameMenuItem( MultiFrameApplication application )
    {
