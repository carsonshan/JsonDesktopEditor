...
import ge.framework.application.multi.dialog.ApplicationStandardDialog;
...
public class RecentDialog extends ApplicationStandardDialog implements ActionListener
{
    ...
    public RecentDialog(MultiFrameApplication application)
    {
        super( application );
            ...
            if ( frameInstanceDetailsObject != null )
            {
                if ( frameInstanceDetailsObject.doesConfigurationFileExist() == false )
                {
                    MissingLocationDialog missingLocationDialog =
                            new MissingLocationDialog( frameInstanceDetailsObject.getName(),application );
                ...
                else if ( frameInstanceDetailsObject.isConfigurationFileLocked() == true )
                {
                    LockedLocationDialog lockedLocationDialog =
                            new LockedLocationDialog( frameInstanceDetailsObject.getName(), application );
